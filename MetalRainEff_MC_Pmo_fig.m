...
xlim([0 100])
text(3, 0.192, 'a', 'FontSize', 20, 'FontWeight', 'bold')
ax = gca;
ax.Layer = 'top';

axes('Position', [0.265 0.175 0.07 0.17]);
box on
...
yticks([0 0.04 0.08 0.12 0.16 0.20])
xlim([0 100])
text(3, 0.192, 'b', 'FontSize', 20, 'FontWeight', 'bold')
ax = gca;
ax.Layer = 'top';
