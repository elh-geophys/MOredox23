...
%
% Inputs:  P, T, Fe3+/sumFe ("r_eq"), sheet for composition (in
% MoleWeights.xlsx)
% Output: log10(fO2) compared to IW (DeltaIW)

clear;

% read desired geotherm
geodata = readmatrix('\db\geotherms.xlsx', 'Sheet', '3500K');
T = geodata(:,4);
P = geodata(:,2);
r = geodata(:,7);
...
% desired composition
compSheet = 'Deng20';      %Deng20 or Armstrong19
...
[logfO2_test,~] = getfO2_H22(P,T,r,compSheet);
